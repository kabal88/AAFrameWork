...
namespace AAFramework.Core.CodeGenerator
{
    public class GenerateIdentifiersMap : Editor
    {
        ...
        private static readonly string CustomGenerated = "/CustomGenerated/";
        ...
        private static void SaveToFile(string data)
        {
            ...
            var pathToDirectory = scriptPath + CustomGenerated;
            ...
            {
                UnityEngine.Debug.LogError("can't make" + pathToDirectory);
            }
        }
    }
}