namespace AAFramework.Core
{
    public static class ModifiersCalculation
    {
        ...
        public static long GetResult(in long modifiedValue, in long parametr, ModifierCalculationType modifierCalculationType, ModifierValueType modifierValueType)
        {
            switch (modifierValueType)
            {
                case ModifierValueType.Value:
